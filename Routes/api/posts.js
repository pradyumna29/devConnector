      ...
      Post.findById(req.params.id)
        .then(post => {
          if (
            ...
            return res
              .status(400)
              .json({ notLiked: "User never liked the post" });
          }
          // Get remove index
...
// @route  post api/posts/comment/:id id is post id
// @de3sc  add comment
// @access Private
router.post(
  "/comment/:id",
...
// @route  DELETE api/posts/comment/:id/:comment_id id is post id
// @de3sc  delete comment
// @access Private
router.delete(
